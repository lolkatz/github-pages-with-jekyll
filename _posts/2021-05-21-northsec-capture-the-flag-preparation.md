...
![Northsec 2021 badge](/assets/images/nsec2021-badge.png)
...
![CTF warmup questions](/assets/images/warmup-flag.png)
...
![More warmup](/assets/images/more-warmup.png)
...
![Hack one more time](/assets/images/hack-one-more-time.png) 
...
![Hidden IP](/assets/images/hidden-ip.png)
...
![CTF 101](/assets/images/capture-the-flag-101.png)
...
![Hydra](/assets/images/hydra-crackme.png)
...
![pawngdb](/assets/images/pawngdb.png)
...
![Pawngdb with source code](/assets/images/gdb-with-source-code.png)
...
![Modified service source code](/assets/images/modified-service-source-code.png)
...
![Kali OpenVPN configuration](/assets/images/kali-openvpn-config.png)

I did had to search a little for the Routes options tough because I didn't had internet access on my machine at first:

![Kali OpenVPN configuration - routes](/assets/images/kali-openvpn-config2.png)
...
![Kali OpenVPN configuration - routes](/assets/images/first-blood.png)
